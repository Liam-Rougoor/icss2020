...
public class ICSSParser extends Parser {
	...
	public static final int
		RULE_stylesheet = 0, RULE_stylesheet_rule = 1, RULE_selector = 2, RULE_declaration = 3, 
		RULE_property = 4, RULE_value = 5;
	private static String[] makeRuleNames() {
		return new String[] {
			"stylesheet", "stylesheet_rule", "selector", "declaration", "property", 
			"value"
		};
	}
	...
	public static class StylesheetContext extends ParserRuleContext {
		public List<Stylesheet_ruleContext> stylesheet_rule() {
			return getRuleContexts(Stylesheet_ruleContext.class);
		}
		public Stylesheet_ruleContext stylesheet_rule(int i) {
			return getRuleContext(Stylesheet_ruleContext.class,i);
		}
	...
	public static class Stylesheet_ruleContext extends ParserRuleContext {
		...
		public Stylesheet_ruleContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_stylesheet_rule; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).enterStylesheet_rule(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).exitStylesheet_rule(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ICSSVisitor ) return ((ICSSVisitor<? extends T>)visitor).visitStylesheet_rule(this);
			else return visitor.visitChildren(this);
		}
	}

	public final Stylesheet_ruleContext stylesheet_rule() throws RecognitionException {
		Stylesheet_ruleContext _localctx = new Stylesheet_ruleContext(_ctx, getState());
		enterRule(_localctx, 2, RULE_stylesheet_rule);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PropertyContext property() throws RecognitionException {
		...
		try {
			...
			setState(33);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PROP_COLOR) | (1L << PROP_BACKGROUND_COLOR) | (1L << PROP_WIDTH) | (1L << PROP_HEIGHT))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static final String _serializedATN =
		...
		"\3\3\6\3\27\n\3\r\3\16\3\30\3\3\3\3\3\4\3\4\3\5\3\5\3\5\3\5\3\5\3\6\3"+
		"\6\3\7\3\7\3\7\2\2\b\2\4\6\b\n\f\2\5\4\2\f\r\22\22\3\2\16\21\4\2\b\t\13"+
		"\13\2#\2\17\3\2\2\2\4\23\3\2\2\2\6\34\3\2\2\2\b\36\3\2\2\2\n#\3\2\2\2"+
		"\f%\3\2\2\2\16\20\5\4\3\2\17\16\3\2\2\2\20\21\3\2\2\2\21\17\3\2\2\2\21"+
		"\22\3\2\2\2\22\3\3\2\2\2\23\24\5\6\4\2\24\26\7\25\2\2\25\27\5\b\5\2\26"+
		"\25\3\2\2\2\27\30\3\2\2\2\30\26\3\2\2\2\30\31\3\2\2\2\31\32\3\2\2\2\32"+
		"\33\7\26\2\2\33\5\3\2\2\2\34\35\t\2\2\2\35\7\3\2\2\2\36\37\5\n\6\2\37"+
		" \7\30\2\2 !\5\f\7\2!\"\7\27\2\2\"\t\3\2\2\2#$\t\3\2\2$\13\3\2\2\2%&\t"+
		"\4\2\2&\r\3\2\2\2\4\21\30";
